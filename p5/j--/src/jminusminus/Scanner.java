...
class Scanner {
    ...
    /** For determine double number or not. */
    private boolean doubleNum;
    
    /** For save the previous character. */
    private char pre;
    /**
    ...
    public TokenInfo getNextToken() {
        ...
        while (moreWhiteSpace) {
            ...
            if (ch == '/') {
                ...
                if (ch == '*') {
                	...
                	if(ch == EOFCH) {
                	  reportScannerError("No '*/' for end of multi-line comments");
                	}
                } else if (ch == '=') {
                	nextCh();
        ...
        case '^':
        	...
        	if(ch == '=') {
        		nextCh();
        		return new TokenInfo(CARET_ASSIGN, line);
        	} else {
        		return new TokenInfo(CARET, line);
        	}
        case '%':
        	nextCh();
        	if(ch == '=') {
        ...
        case '!':
            ...
            if (ch == '='){
            	nextCh();
            	return new TokenInfo(LNOTE, line);
            } else {
        ...
        case '>':
            ...
            if (ch == '='){
            	...
            	if (ch == '>') {
            		...
            		if(ch == '=') {
            			nextCh();
            			return new TokenInfo(UNSIGN_R_SHIFT_ASSIGN, line);
            		} else {
            			return new TokenInfo(UNSIGN_R_SHIFT, line);
            		}
            	} else if (ch == '=') {
            		nextCh();
            		return new TokenInfo(R_SHIFT_ASSIGN, line);
            	} else {
        ...
        case '<':
            ...
            if (ch == '=') {
            	...
            	if (ch == '='){
            		nextCh();
            		return new TokenInfo(L_SHIFT_ASSIGN, line);
            	} else {
        ...
        case '.':
            nextCh();
            if (ch == '_')
            	reportScannerError("invalid Number");
            if (isDigit(ch) || ch == '_'){
            	buffer = new StringBuffer();
            	buffer.append('.');
        ...
        case '0':
            ...
            if (doubleNum)
            	...
            	reportScannerError("invalid integer");
    ...
    /**
     * Return true if the specified character is an exponent indicator;
     * false otherwise.
     * 
     * @param c
     * 			  character.
    ...
    private boolean isExponentIndicator(char c) {
    	return (c == 'e' || c == 'E');
    }
    
    /**
     * Return true if the specified character is a float type suffix;
     * false otherwise.
     * 
     * @param c
     * 			  character
    ...
    /**
     * Return true if the specified character is a sign operator;
     * false otherwise.
     * 
     * @param c
     * 			  character
